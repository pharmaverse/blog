...
- [ ] Ensure your new post folder is of the form `"posts/date_with_short_tile"` and the blog post file and any other artifacts have informative but succint names.
