...
create_post(
  post_name = "Automatic slide generation with {autoslideR}", # needs to be character vector (length 1)
  post_date = "2025-03-01", # needs to be length 1 character vector and will be auto-updated when your post is merged
  description = "", # you can fill the description in later as well
  author = c("Stefan P. Thoma"), # one or more authors are permitted
