...
derive_vars_extreme_event() has a much richer example with events from other domains that is more aligned to where you would use this function. 
...
out the more detailed example in the [function documentation](https://pharmaverse.github.io/admiral/cran-release/reference/derive_vars_extreme_event.html) to see its true power!
...
Each bug fixed by our development team is documented in our [changelog](https://pharmaverse.github.io/admiral/cran-release/news/index.html#updates-of-existing-functions-1-0-0) with the Issue linked. 
