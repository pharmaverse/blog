...
apply SDTM mapping functions to map the target SDTM variables. Below is
an example snippet that shows how to use a raw AE dataset from
...
ae_raw <- convert_blanks_to_na(ae_raw)
