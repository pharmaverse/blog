...
As usual, you can access these reference examples from our [documentation website](https://pharmaverse.github.io/admiral/cran-release/reference/) or alternatively directly from RStudio's own Help pane by typing `?function_name` in the console.
