...
Here is our initial calendar of events and watch out for more details on how you
can sign up and get involved:

| Package                                             | Target Date       | Timezone |
|-----------------------------------------------------|-------------------|----------|
| `{xportr}`                                          | April 2nd         | EST      |
| `{teal}` - @ R/Medicine conference                  | April 23rd        | PST      |
| `{aNCA}`                                            | July 16th         | CET      |
| `{autoslider}` - @ R/Pharma conference              | Week of Sept 28th | CST      |
| `{gtsummary}` & `{cards/x}` - @ R/Pharma conference | Week of Sept 28th | PST      |
| `{logrx}`                                           | Early November    | EST      |
