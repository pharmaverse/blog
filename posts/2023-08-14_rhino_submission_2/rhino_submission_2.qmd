...
The R Consortium Submissions Working Group successfully completed an R-based submission in November 2021 through the eCTD portal (R Submissions Pilot 1).
...
Moving forward, the Pilot 2 aimed to include a Shiny application that the FDA staff could deploy on their own servers.
