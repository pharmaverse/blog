...
If you are interested in learning more about the thoughts that went into the feedback application, you can read about it in [this blogpost](https://pharmaverse.github.io/comms_wg/posts/2023-06-19_hackathon_app/) or check out my [public GitHub repository for such an application](https://github.com/StefanThoma/hackathon_app).
