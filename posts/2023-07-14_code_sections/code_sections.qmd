...
Once the user saves this template program and opens it in their the local file system, a 100+ line file instantly becomes more tractable due to the code sections that have been inserted.
  <br/>
