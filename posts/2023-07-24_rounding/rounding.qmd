...
-   SAS `round()` [rounds away from zero](https://documentation.sas.com/doc/en/pgmsascdc/9.4_3.5/lefunctionsref/p0tj6cmga7p8qln1ejh6ebevm0c9.htm#p0zr4tmk27unjwn1izg4801h5l46). So, `1.5` would be rounded to 2 whereas `-1.5` to `-2`.
