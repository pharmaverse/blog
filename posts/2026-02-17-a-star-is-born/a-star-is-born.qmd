---
title: "Your Star Matters: Why GitHub Stars Are Vital to the Pharmaverse"
author:
  - name: Jeff Dickinson
...
Our industry is not the easiest audience for open-source advocacy. We operate in a validated, regulated environment where change is scrutinized and risk aversion runs deep. The transition from SAS to R — and the cultural shift toward open, collaborative tool development — is still very much in progress.
...
Here is something worth acknowledging: pharmaverse packages are, in general, **understarred relative to their actual usage and impact**.

This is partly a cultural artifact. In the pharmaceutical programming world, we have not historically operated in GitHub-native workflows. Many of us spent years — or decades — in SAS environments where there was no equivalent of a "star." The habit of engaging with an open-source repository beyond simply downloading the package is something we are still building as a community.

It is also partly a visibility problem. Many clinical programmers use pharmaverse packages through internal environments where GitHub access may be limited or indirect. They derive real value from the tools but never navigate to the source repositories.

Both of these things can change — and the first step is simply awareness.
...
| `{metacore}` | [pharmaverse/metacore](https://github.com/pharmaverse/metacore) |
| `{metatools}` | [pharmaverse/metatools](https://github.com/pharmaverse/metatools) |
| `{xportr}` | [pharmaverse/xportr](https://github.com/pharmaverse/xportr) |
