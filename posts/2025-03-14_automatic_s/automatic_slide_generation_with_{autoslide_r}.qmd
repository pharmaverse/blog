...
You can find t0he developer guidelines at the [package homepage](https://pharmaverse.github.io/autoslider.core/latest-tag/articles/opensource.html).
...
The following example `specs.yml` content would create two outputs based off of two template functions, [t_ds_slide()](https://pharmaverse.github.io/autoslider.core/latest-tag/reference/t_ds_slide.html?q=t_ds#null) and [t_dm_slide()](https://pharmaverse.github.io/autoslider.core/latest-tag/reference/t_dm_slide.html?q=t_dm_slide#null):
...
## Functions
An overview of all `{autoslider.core}` functions can be found [here](https://pharmaverse.github.io/autoslider.core/latest-tag/reference/index.html). 
