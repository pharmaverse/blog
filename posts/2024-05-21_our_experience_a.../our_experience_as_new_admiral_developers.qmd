...
author:
  - name: Fanny Gautier
  - name: Lina Patil
description: "Having joined the {admiral} family quite recently, we are very excited to share with you our first steps and thoughts in this new adventure"
date: "2024-05-21"
...
<!--------------- post begins here ----------------->
# what experience you had when you started 

As a starting point, we have gone through the [{admiral} documentation](https://pharmaverse.github.io/admiraldev/articles/programming_strategy.html), and [how to create a package](https://r-pkgs.org/) websites to get familiar with the work and processes. There is no need to memorize everything, it’s only to get an overview and know that the documentation is available and can be reviewed at any time. Then, we were encouraged to take on and resolve our first dummy issue which was to create an initial and easy function. This was a concrete example to proceed with the full process of creation, documentation and building site. What was amazing is that we have received so much support from the {admiral} Community on how to get started with this dummy issue.  

Moreover, weekly meetings have been set up for the first few weeks to support our integration in the team and to address any queries or issues we may have. This helped us a lot to familiarize ourselves with the processes and requirements of this open-source project. 

In addition to these meetings, bi-weekly meetings were scheduled with the core development team to discuss and dispatch the tasks within the team, as well as issues newcomers are facing during their on-boarding. Before a new version is released, this bi-weekly meeting becomes a weekly meeting. 
...
Another challenge is to understand the automatic CI/CD (Continuous Integration / Continuous Delivery) checks and their dependencies with other packages such as {admiraldev}. The CI/CD checks are made not to break down the current code while being updated. Some of these tests are implemented within the {admiraldev} package and used in {admiral} while creating a Pull request. Those updates can thus have some impacts on the {admiral} package itself. 

# What have you enjoyed 

Becoming a co-developer and active contributor to {admiral} was an excellent opportunity for us to learn and to grow, and a challenge which we accepted with enthusiasm. By utilizing our backend expertise, we demonstrated our ability to adapt to new programming languages, frameworks, and tools. By working on this open-source issue, we were able to expand our technical horizons and strengthen our problem-solving abilities. 
