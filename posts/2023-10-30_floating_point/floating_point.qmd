...
This is now implemented throughout `atoxgr_criteria_daids`, `atoxgr_criteria_ctcv4`, and `atoxgr_criteria_ctcv5`, and we are looking into implementing this for `derive_var_anrind` as well.
