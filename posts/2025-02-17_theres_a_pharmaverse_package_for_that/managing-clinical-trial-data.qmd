...
2.  **Tabulation** – Structuring and validating data with:
    ...
    -   [**timber**](https://rdrr.io/github/atorus-research/timber/) for traceability and logging.
...
-   **Regulatory Agencies ([FDA](https://www.fda.gov/), [CDISC](https://www.cdisc.org/), [PHUSE](https://phuse.global/))** – Setting standards for clinical data reporting.
