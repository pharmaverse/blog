...
-   **Modular design allows for extensions** that focus on specific areas or needs, 3 public packages are currently extending {admiral}, such as [{admiralonco}](https://github.com/pharmaverse/admiralonco), [{admiraloptha}](https://github.com/pharmaverse/admiralophtha) and [{admiralvaccine}](https://github.com/pharmaverse/admiralvaccine). All of them were created from the [admiral template](https://github.com/pharmaverse/admiraltemplate).
...
-   [Overview of R {admiral}](https://www.pharmasug.org/proceedings/japan2023/PharmaSUG-Japan-2023-08.pdf) 
...
-   Its **reporter functionality** allows users to **build custom reports** based on the visualizations filtered and parametrized in the app. Users can generate PDFs or PPT documents that include images and optional code.
...
3.  It provides a set o**f functions for common data transformation tasks,** such as converting between CDISC datasets, handling missing values, and applying CDISC-specific terminology.
