...
Around the same time, Thomas Neitmann (currently at Denali Therapeutics, then at Roche) and Rimler discovered that both were working with ADaM in R, so Neitmann, Ross and Rimler saw an opportunity there and GSK started their partnership with Roche to build and release [*admiral*](https://github.com/pharmaverse/admiral) package.
