...
In total, 8 tasks were available for the programmers: ADSL, ADAE, ADLBC, ADVS, ADTTE, ADADAS, ADLBH & ADLBHY.
Participants' solutions generated via their respective R scripts were checked against the solutions we provided. 
There was an incredible amount of activity going on in the slack channel we set up for discussions -- also due to some errors in the specs file which lead to contradictory feedback on the feedback application.
However, during the month of February we managed to respond to most of the participants' issues and continuously improved the feedback application and the specs sheet for clarification.
...
Shout-out to our community hero: [Jagadish Katam](https://www.linkedin.com/in/jagadishkatam/) without whom most issues related to the task programming raised by the community would not have been addressed as quickly as they were. Huge thanks from the organisors!
