...
description: "Containers in the pharmaverse"
...
As an active contributor to the pharmaverse blog, I've always appreciated the opportunity to share new insights and tools with our community. While the blog publishing process has been effective, we continuously seek ways to optimize our workflows. Currently, the CI/CD pipeline for publishing the blog typically took about 17 minutes to deploy a new post. Unfortunately, I was unsure how to create a new container/image to meet my needs and relied on some straight `install.packages()` in the CI/CD pipeline. Luckily, I crossed paths with the fabulous Maciej Nasinski and we built a specific
...
of this container (like devcontainers) or building additional containers for certain purposes. For those interested, we would be happy to provide a tutorial on containers. Get in touch if you have ideas or want to get involved!
...
and explored in the blog, this became really cumbersome!
