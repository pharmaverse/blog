...
As an active contributor to the Pharmaverse blog, I've always appreciated the opportunity to share new insights and tools with our community. While our publishing process has been effective, we continuously seek ways to optimize our workflows. Our CI/CD pipeline for the blog, for instance, typically took about 17 minutes to deploy a new post. This duration has now seen a notable reduction, thanks to the introduction of a new container technology and the guidance of Maciej Nasinski.
