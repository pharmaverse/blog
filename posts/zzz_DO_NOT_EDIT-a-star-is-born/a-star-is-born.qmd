...
![GitHub star button location](github-star-button.png)

1. Navigate to any pharmaverse package repository on GitHub
2. Look for the ⭐ **Star** button in the top-right area of the repository, just below your profile menu
3. Click it once — that's it!
...
| `{Tplyr}` | [atorus-research/Tplyr](https://github.com/atorus-research/Tplyr) |
...
| `{tern}` | [insightsengineering/tern](https://github.com/insightsengineering/tern) |
| `{tidytlg}` | [pharmaverse/tidytlg](https://github.com/pharmaverse/tidytlg) |
| `{tfrmt}` | [GSK-Biostatistics/tfrmt](https://github.com/GSK-Biostatistics/tfrmt/) |
| `{visR}` | [openpharma/visR](https://github.com/openpharma/visR/) |
| `{ggsurvfit}` | [pharmaverse/ggsurvfit](https://github.com/pharmaverse/ggsurvfit) |
| `{aNCA}` | [pharmaverse/aNCA](https://github.com/pharmaverse/aNCA) |
| `{rhino}` | [Appsilon/rhino](https://github.com/Appsilon/rhino) |
| `{metacore}` | [atorus-research/metacore](https://github.com/atorus-research/metacore) |
| `{metatools}` | [pharmaverse/metatools](https://github.com/pharmaverse/metatools) |
| `{xportr}` | [atorus-research/xportr](https://github.com/atorus-research/xportr) |
| `{riskmetric}` | [pharmaR/riskmetric](https://github.com/pharmaR/riskmetric) |
| `{sdtm.oak}` | [pharmaverse/sdtm.oak](https://github.com/pharmaverse/sdtm.oak/) |
