...
(such as [git](https://git-scm.com/book/en/v2/Getting-Started-What-is-Git%3F)) which could make an initial barrier.
...
-   Be kind to yourself and take on one of the easier issues to build
    confidence - these are often labelled "good first issue" and might
