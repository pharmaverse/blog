...
Let's start our journey with [{rtables}](https://github.com/pharmaverse/rtables), a package contributed by [Roche](https://www.roche.com/), which enables the creation of tables for reporting clinical trials.
...
[{rtables}](https://github.com/pharmaverse/rtables) was primarily designed to address the needs of the pharmaceutical industry for creating regulatory-ready tables for clinical trial reporting.
...
The [{rtables}](https://github.com/pharmaverse/rtables) package offers several features that make it a useful tool for creating complex tables:

-   [{rtables}](https://github.com/pharmaverse/rtables) allows you to define tables with a **hierarchical, tree-like structure**, enabling the creation of multi-level tables with nested rows and columns.
...
The following example demonstrates how to create a basic table using the [{rtables}](https://github.com/pharmaverse/rtables) package.
...
We then define a function to calculate the mean of a biomarker and use [{rtables}](https://github.com/pharmaverse/rtables) functions to build and print the table.
...
-   [Introduction to {rtables}](https://pharmaverse.github.io/rtables/latest-release/articles/rtables.html?q=introduction)

-   [GitHub - pharmaverse/rtables: Reporting tables with R](https://github.com/pharmaverse/rtables)  
...
-   [Get Started • admiral](https://pharmaverse.github.io/admiral/cran-release/articles/admiral.html#setup) 
...
-   It is designed to **seamlessly integrate with other [pharmaverse](https://pharmaverse.org/) packages**, such as [{admiral}](https://github.com/pharmaverse/admiral) and [{rtables}](https://github.com/pharmaverse/rtables).
