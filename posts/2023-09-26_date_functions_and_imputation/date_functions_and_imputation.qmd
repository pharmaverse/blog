...
long_slug <- "2023-09-26_date_functions_and_imputation"
...
In this article, we first examine the arsenal of functions provided byadmiral to aid in datetime imputation and timing variable derivation. We then observe everything in action through a number of selected typical examples.
