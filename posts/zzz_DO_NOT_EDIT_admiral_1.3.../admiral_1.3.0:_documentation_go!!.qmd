...
We've also been busy updating some of our existing functions in response to bug fixes and requests for enhancements. You can find the full list of updates in the [Changelog](https://pharmaverse.github.io/admiral/main/news/index.html).
