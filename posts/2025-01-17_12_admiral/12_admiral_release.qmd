...
As always, we have listed the full set of 1.2 updates in our [changelog](https://pharmaverse.github.io/admiral/cran-release/news/index.html), and have picked out only a select few updates to discuss.
