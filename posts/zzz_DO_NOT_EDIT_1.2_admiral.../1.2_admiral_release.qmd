...
As always, we have listed the full set of 1.2 updates in our [changelog](https://pharmaverse.github.io/admiral/news/index.html), and have picked out only a select few new functions to discuss.
...
* admiral::derive_vars_crit_flag():  Derives ADaM compliant criterion flags to facilitate subgroup analyses like `CRITy`, `CRITyFL`, and `CRITyFN`.
...
Below you can expand to get a few simple example of this new function with dummy data in action.  Be sure to check out the function's documentation on the admiral website for full understanding of admiral::derive_vars_crit_flag().
...
[admiraldiscovery](https://pharmaverse.github.io/admiraldiscovery/articles/reactable.html) is a standalone website has a nice interative table to help identify common ADaM variables and the {admiral} functions that derive them.
...
{admiral} plans for two releases in 2025 with an early summer release and an end of year release.  We plan on continuing to update admiral based on user feedback.  Please do not hesistate to [create an issue](https://github.com/pharmaverse/admiral/issues) on making documentation clearer, you found a pesky bug, you have an idea for a function or something else!  We love feedback and you can even [implement your idea](https://github.com/pharmaverse/admiral/issues/1839) if the core team gives their approval.    

admiral has a Discssuion thread on potential ideas for our 1.3 release.  You can contribute or follow along in the discussion [here](https://github.com/pharmaverse/admiral/discussions/2191)
