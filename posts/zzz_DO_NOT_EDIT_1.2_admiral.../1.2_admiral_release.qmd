...
The three new functions available in this release are:
...
* admiral::transform_scale(): Transforming questionnaire values into a standardized scale
...
Below you can expand to get a full walk through of new function with dummy data.  Check it out!!
...
* At R/Pharma 2024:
  * Ben Straub and Fanny Gautier led an *"ADaM Workshop"* - [slides here](https://pharmaverse.github.io/rpharma-2024-ADaM-workshop/#/title-slide), [repo here](https://github.com/pharmaverse/rpharma-2024-ADaM-workshop).
