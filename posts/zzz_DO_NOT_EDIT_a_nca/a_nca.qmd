...
This tool is built in `RShiny` with user-friendliness in mind, allowing both novice and experienced users to seamlessly integrate it into their workflows.
