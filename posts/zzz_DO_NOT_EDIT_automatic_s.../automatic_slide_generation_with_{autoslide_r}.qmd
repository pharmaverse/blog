...
This package let's users create slides with study-specific outputs in an automated and reproducible way -- without the need to copy-paste.
...
The following example `filters.yml` file specifies 4 commonly used filters:
