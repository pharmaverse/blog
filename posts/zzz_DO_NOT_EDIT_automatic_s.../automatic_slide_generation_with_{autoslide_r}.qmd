...
We are excited to announce that the autoslider.core package is now a part of Pharmaverse! This integration enhances the workflows for creating study-specific output slidedecks by providing a structured framework that supports a wide array of outputs with easy customization options. In this blog post, we will guide you through the autoslider.core package and demonstrate how it can be used to streamline your data analysis and output slide generation.
