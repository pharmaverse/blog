...
Creating `--DY` variables for your ADaMs is super easy using  [`derive_vars_dy()`](https://pharmaverse.github.io/admiral/cran-release/reference/derive_vars_dy.html) from the [admiral package](https://pharmaverse.github.io/admiral/).
