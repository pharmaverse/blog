...
Available on [CRAN](https://cran.r-project.org/web/packas/random.cdisc.data/index.html). The package is actively maintained on [GitHub](https://github.com/insightsengineering/random.cdisc.data) by the NEST team.
